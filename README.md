...
This project was forked from https://github.com/GuangchuangYu/cv  
...
- `index.html`: The final output of the template when the header variable `PDF_EXPORT` is set to `FALSE`. View it at [FanJingithub.github.io/cv](http://FanJingithub.github.io/cv).
