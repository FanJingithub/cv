...
- **Programming language**: Java, Python, R, JavaScript, and C.
- **Algorithm**: Algorithm design and optimization (dynamic programming, graph theory, etc).
- **Data analysis**: Clinical statistics, machine learning, and CNN with PyTorch (such as ResNet).
...
<p style="font-size:0.80rem">I am interested in oncology, bioinformatics, statistics, and computer science.<p>
